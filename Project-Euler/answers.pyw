...
with open('answers') as file: answers=eval(file.read())
...
class MainLayout(QVBoxLayout):
	...
	def updateAnswer(self,self_):
		if self_.line_input.text() in answers.keys(): self_.answer.setText(answers[self_.line_input.text()])
		else: self_.answer.setText('Invalid question number')
